...
<x-layouts.dashboard :user="$user" :nav-sections="$navSections" :page-title="$pageTitle" account-heading="System" :settings-href="route('lgu.settings')">
    <x-dashboard.page-header
        ...
        description="Sentiment analysis results from tourist feedback in {{ $municipality }}."
    />
    ...
    <div class="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div class="rounded-md border border-sand-200 bg-sand-0 p-5 lg:col-span-2">
                ...
                <div class="flex items-center gap-1 rounded-sm border border-sand-300 bg-sand-50 p-1 text-xs font-semibold">
                    @foreach (['week' => 'This Week', 'month' => 'This Month', 'year' => 'This Year'] as $period => $label)
                        <button
                            ...
                            data-trend-target="lgu-sentiment-trend"
            ...
            <div class="mt-4" id="lgu-sentiment-trend" data-trend-chart="lgu-sentiment-trend-data">
            ...
            <script type="application/json" id="lgu-sentiment-trend-data">@json($sentimentTrend)</script>
        </div>
    </div>
