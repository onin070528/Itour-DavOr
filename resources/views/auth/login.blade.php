...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="relative flex min-h-screen items-center justify-center overflow-hidden bg-primary-900 px-4 py-12">
        ...
        <div class="absolute inset-0" aria-hidden="true">
            ...
            >
            <div class="absolute inset-0 bg-gradient-to-b from-primary-900/85 via-primary-900/55 to-primary-900/85"></div>
            <div class="absolute inset-0 bg-primary-900/20"></div>
        </div>

        <div class="relative w-full max-w-md rounded-lg border border-sand-200 bg-sand-0 p-8 shadow-xl">
